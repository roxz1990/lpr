...
#define MAX_PACKET_SIZE 900  // Maximum possible UDP packet size (including headers)
#define PAYLOAD_SIZE 900     // Ideal payload size for UDP packets (leaving space for headers)
